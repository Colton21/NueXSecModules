...
for cut in range(num_cuts):
    ...
    #***************************************************
    # flash_time_end is a value we'd like to investigate:
    flash_time_end = 15.0 + (run * 0.1)
    # flash_time_end - scan between 15.0 - 17.0 ms
    loop_cut.append(flash_time_end)
...
f1_axes.set_title("Efficiency vs Flash Time End")
f1_axes.set_autoscaley_on(False)
f1_axes.set_ylim([9, 11])
f1_axes.set_xlabel("Flash Time End [ms]")
f1_axes.set_xlim([14.8, 17.2])
f1_axes.set_ylabel("Efficiency")
figure_1.savefig("plots/final_efficiency_flash_time_end.pdf")

figure_2 = plt.figure()
plt.plot(loop_cut, purity_final, 'bo')
f2_axes = figure_2.add_subplot(111)
f2_axes.set_title("Purity vs Flash Time End")
f2_axes.set_autoscaley_on(False)
f2_axes.set_ylim([42, 58])
f2_axes.set_xlabel("Flash Time End [ms]")
f2_axes.set_xlim([14.8, 17.2])
f2_axes.set_ylabel("Purity")
figure_2.savefig("plots/final_purity_flash_time_end.pdf")
