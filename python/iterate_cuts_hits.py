...
for cut in range(num_cuts):
    ...
    # initially trying 0 - 300 in 20 hit intervals
    shwr_hit_threshold = 0.0 + (run * 20.0)
    loop_cut.append(shwr_hit_threshold)
...
figure_1.savefig("plots/final_efficiency_hits.pdf")
...
figure_2.savefig("plots/final_purity_hits.pdf")
