...
for cut in range(num_cuts):
    ...
    #***************************************************
    # flash_pe_threshold is a value we'd like to investigate:
    tolerance_open_angle_max = 10.0 + (run * 1)
    # tolerance_open_angle_max - scan between 10.0 - 25.0 PE
    loop_cut.append(tolerance_open_angle_max)
...
f1_axes.set_title("Efficiency vs Open Angle Max")
f1_axes.set_autoscaley_on(False)
f1_axes.set_ylim([8, 11])
f1_axes.set_xlabel("Open Angle Max [Degrees]")
f1_axes.set_xlim([11, 27])
f1_axes.set_ylabel("Efficiency")
figure_1.savefig("plots/final_efficiency_open_angle_max.pdf")

figure_2 = plt.figure()
plt.plot(loop_cut, purity_final, 'bo')
f2_axes = figure_2.add_subplot(111)
f2_axes.set_title("Purity vs Open Angle Max")
f2_axes.set_autoscaley_on(False)
f2_axes.set_ylim([50, 60.5])
f2_axes.set_xlabel("Open Angle Max [Degrees]")
f2_axes.set_xlim([11, 27])
f2_axes.set_ylabel("Purity")
figure_2.savefig("plots/final_purity_open_angle_max.pdf")
