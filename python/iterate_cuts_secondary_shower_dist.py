...
for cut in range(num_cuts):
    ...
    #***************************************************
    # dist_tolerance is a value we'd like to investigate:
    dist_tolerance = 10.0 + (run * 1)
    # dist_tolerance - scan between 10.0 - 30.0 cm
    loop_cut.append(dist_tolerance)
...
f1_axes.set_title("Efficiency vs 2nd Shower Dist")
f1_axes.set_autoscaley_on(False)
f1_axes.set_ylim([9, 11])
f1_axes.set_xlabel("2nd Shower Dist")
f1_axes.set_xlim([9, 31])
f1_axes.set_ylabel("Efficiency")
figure_1.savefig("plots/final_efficiency_secondary_shower_dist.pdf")

figure_2 = plt.figure()
plt.plot(loop_cut, purity_final, 'bo')
f2_axes = figure_2.add_subplot(111)
f2_axes.set_title("Purity vs 2nd Shower Dist")
f2_axes.set_autoscaley_on(False)
f2_axes.set_ylim([56, 60])
f2_axes.set_xlabel("2nd Shower Dist")
f2_axes.set_xlim([9, 31])
f2_axes.set_ylabel("Purity")
figure_2.savefig("plots/final_purity_secondary_shower_dist.pdf")
