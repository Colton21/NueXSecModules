...
xsec_ana::TpcObjectAnalysis::TpcObjectAnalysis(fhicl::ParameterSet const & p)
	:
	EDAnalyzer(p) // ,
...
void xsec_ana::TpcObjectAnalysis::reconfigure(fhicl::ParameterSet const &p)
{
...
void xsec_ana::TpcObjectAnalysis::analyze(art::Event const & e)
{
...
void xsec_ana::TpcObjectAnalysis::endSubRun(art::SubRun const & sr) {
