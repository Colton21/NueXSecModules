...
c4.Print("prescale_value_bnb.pdf")

c5 = TCanvas()
c5.cd()
h_prescale_val_unbiased.GetXaxis().SetTitle("Prescale Value [%]")
h_prescale_val_unbiased.Draw()
c5.Print("prescale_value_unbiased.pdf")

c6a = TCanvas()
c6a.cd()
h_pass_numi.Draw()
c6a.Print("pass_numi.pdf")

c6b = TCanvas()
c6b.cd()
h_pass_bnb.Draw()
c6b.Print("pass_bnb.pdf")

c6c = TCanvas()
c6c.cd()
h_pass_unbiased.Draw()
c6c.Print("pass_unbiased.pdf")

c6d = TCanvas()
c6d.cd()
h_pass_combo.Draw()
c6d.Print("pass_combo.pdf")
